subs = {
  ...
  'mixed' : [
    ...
    ('dplasma_complex64_t',   'double'           ),
    ('dplasma_complex32_t',   'float'            ),
    ('PARSEC_MATRIX_COMPLEX_DOUBLE','PARSEC_MATRIX_DOUBLE'),
    ('PARSEC_MATRIX_COMPLEX_FLOAT', 'PARSEC_MATRIX_FLOAT' ),
    ('zlange','dlange'),
    ('zlag2c','dlag2s'),
    ('clag2z','slag2d'),
    ('zlacpy','dlacpy'),
  ...
  'normal' : [ ## Dictionary is keyed on substitution type
    ...
    ('PARSEC_MATRIX_FLOAT',    'PARSEC_MATRIX_DOUBLE',   'PARSEC_MATRIX_FLOAT',    'PARSEC_MATRIX_DOUBLE'   ),
    ...
    ('gflops_fp32', 'gflops_fp64', 'gflops_fp32', 'gflops_fp64'),
